...
const HomeScreen = () => {
    ...
    const [locationServicesEnabled, setLocationServiceEnable] = useState(false);
    useEffect(() => {
        ...
        <ScrollView style={{ backgroundColor: '#F0F0F0', flex: 1, marginTop: 30 }}>
            ...
            <View style={{ marginTop: 30, flexDirection: 'row', alignItems: 'center', padding: 10 }}>
                ...
                <Pressable onPress={() => navigation.navigate("Profile")} style={{ marginLeft: 'auto', marginRight: 7 }}>
                    <Image style={{ width: 40, height: 40, borderRadius: 20 }} source={{ uri: "https://lh3.google.com/u/0/ogw/AAEL6siWJdIpvgJD7m7US_uFmoOFQX6TcaDMPamVsfnS=s32-c-mo" }} />
                </Pressable>
            </View>
