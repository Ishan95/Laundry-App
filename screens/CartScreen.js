                        ...
                        <Pressable style={{ backgroundColor: 'white', borderRadius: 12, marginLeft: 10, marginRight: 10, padding: 14 }}>
                            {cart.map((item, index) => (
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginVertical: 12, }} key={index}>
                                    ...
                                    {/* - + button */}
                                    <Pressable
                                        style={{ flexDirection: 'row', paddingHorizontal: 10, paddingVertical: 5, alignItems: 'center', borderColor: '#BEBEBE', borderWidth: 0.5, borderRadius: 10 }}>
                                        <Pressable
                                            onPress={() => {
                        ...
                        <View style={{marginHorizontal: 10}}>
                            ...
                            <View style={{backgroundColor: 'white', borderRadius: 7, padding: 10, marginTop: 15,}}>
                                ...
                                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                                    ...
                                    <Text style={{fontSize: 18, fontWeight: '500', color: '#088F8F',}}>{route.params.no_Of_days}</Text>
                                </View>
